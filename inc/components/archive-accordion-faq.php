        ...
        <div class="row site-component-row large-cards-row">
            <div class="accordion accordion-flush col-md-10 col-12 a1" id="accordionFlushA1">
                ...
                <?php if(get_sub_field('accordion_option') === 'faq') : ?>
                    ...
                    ?>
                        <div class="accordion-item">
							<?php $a_id = str_replace("-", " ", $answer); ?>
                            <h3 class="accordion-header" id="flush-heading-a1-<?php echo get_row_index() ?>-<?php echo $a_id ?>">
                                <button class="accordion-button collapsed title-text _21" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse-a1-<?php echo get_row_index() ?>-<?php echo $a_id ?>" aria-expanded="false" aria-controls="flush-collapse-a1-<?php echo get_row_index() ?>-<?php echo $a_id ?>">
                                    <?php echo $question ?>
                                </button>
                            </h3>
                            <div id="flush-collapse-a1-<?php echo get_row_index() ?>-<?php echo $a_id ?>" class="accordion-collapse collapse" aria-labelledby="flush-heading-<?php echo get_row_index() ?>-<?php echo $accordion_option ?>" data-bs-parent="#accordionFlushA1">
                ...
                <?php if(get_sub_field('accordion_option') === 'table') : ?>
                    ...
                    ?>
						<?php $a_id = str_replace("-", " ", $table_topic); ?>
                        <div class="accordion-item">
                            <h3 class="accordion-header" id="flush-heading-a1-<?php echo get_row_index() ?>-<?php echo $a_id ?>">
                                <button class="accordion-button collapsed title-text _21" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse-a1-<?php echo get_row_index() ?>-<?php echo $accordion_option ?>" aria-expanded="false" aria-controls="flush-collapse-a1-<?php echo get_row_index() ?>-<?php echo $a_id ?>">
                                    <?php echo $table_topic ?>
                                </button>
                            </h3>
                            <div id="flush-collapse-a1-<?php echo get_row_index() ?>-<?php echo $a_id ?>" class="accordion-collapse collapse" aria-labelledby="flush-heading-<?php echo get_row_index() ?>-<?php echo $a_id ?>" data-bs-parent="#accordionFlushA1">
