...
<div class="container-fluid small-cards-container site-component-container">
    ...
    <div class="row site-component-row">
        <h2 class="title-text _33 col-12"><?php the_field('featured_parks_and_rec_title', 'option') ?></h2>
    </div>
                ...
                <a href="<?php the_permalink(); ?>">
                    <div class="small-card-wrapper">
                        <?php if(wp_get_attachment_image_src(get_post_thumbnail_id($featured_parks_and_rec_item->ID), 'full')[0]) : ?>                
                            <img class="small-cards-image" src="<?php echo wp_get_attachment_image_src(get_post_thumbnail_id($featured_parks_and_rec_item->ID), 'full')[0] ; ?>" >
                        <?php else : ?>
