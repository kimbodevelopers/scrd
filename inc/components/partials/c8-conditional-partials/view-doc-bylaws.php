<?php if(get_field('related_post')) : ?>
    ...
    <a target="__blank" href="<?php echo get_field('related_post')->guid ?>"> <?php echo $total_files - 1 ; ?> Documents - Show All >></a>
<?php endif; ?>

<?php if(get_field('bylaw_file')) : ?>
    <a href="<?php echo get_field('bylaw_file') ?>" target="__blank">
